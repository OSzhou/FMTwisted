...
//        UIImageWriteToSavedPhotosAlbum(cImage, nil, nil, nil)
    ...
    // 判断是否白屏
    public func judgeLoadingStatus(webview: WKWebView, naviController: UINavigationController? = nil, completionHandler: @escaping (_ status: WebviewLoadingStatus) -> Void) {
